      ...
      <form className="Auth-form" onSubmit={registerUser}>
        <div className="Auth-form-content" style={{"margin":"auto"}}>
          ...
          <div className="form-group mt-3">
            <label>Username<p>at least three, at most ten characters.<br/>can contain letter and numbers. only number is not valid. must start with a letter</p></label>
            <input
              type="text"
              name='username'
          ...
          <div className="form-group mt-3">
            <label>Password<p>at least five, at most ten characters.<br/>must contain at least one letter and one number.</p></label>
            <input
              type="password"
              name='password'
              className="form-control mt-1"
